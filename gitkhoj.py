...
# parser.add_argument('-t', '--token', type=str, help="auth_token")
...
parser.add_argument('queries', metavar="queries", type=str, help="queries")
# parser.add_argument('filename', metavar="filename", type=str, help="queries", required=False)
...
def main():
    count = 0
    with open("github-scan.csv",mode='w') as scanoutput:
